...
This [Bot](https://developer.ciscospark.com/bots.html) will use a webhook to receive all messages sent to the Bot, and will "listen" for a specific set of command words. When a command is received, it will perform an action basec on the command.  Any other message sent to the bot will result in the help message being sent back.
...
**TODO - create link to launch web.ciscospark.com and invite bot**
